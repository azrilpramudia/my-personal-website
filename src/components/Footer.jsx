...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-b from-secondary to-primary text-white px-6 md:px-20 py-12">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Brand / Deskripsi */}
        <div>
          <h2 className="text-2xl font-bold mb-4">ItsMeow.</h2>
          <p className="text-sm text-gray-300">
            Frontend passion to upgrade skills and develop projects using modern
            technology.
          </p>
        </div>
